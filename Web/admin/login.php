<?php
	...
	if(isset($_POST['submit'])){
		...
		if($count_admin > 0){
			...
			echo '<script>alert("Tài khoản Admin không hợp lệ");</script>';
...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <div class="col-lg-12 login-title">
      ...
      <input type="text" name="tendangnhap" placeholder="Username" autocomplete="off">
      <i class="typcn typcn-eye" id="eye"></i>
      <input type="password" name="matkhau" placeholder="Passsword" id="pwd" autocomplete="off">
      <label>
        <input type="checkbox">
        <span></span>
